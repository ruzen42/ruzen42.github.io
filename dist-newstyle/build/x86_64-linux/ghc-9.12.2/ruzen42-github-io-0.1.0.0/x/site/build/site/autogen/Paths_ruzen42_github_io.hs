...
{-|
Module      : Paths_ruzen42_github_io
...
-- at runtime using the environment variable ruzen42_github_io_bindir.
...
-- environment variable ruzen42_github_io_libdir.
...
-- using the environment variable ruzen42_github_io_dynlibdir.
...
-- runtime using the environment variable ruzen42_github_io_datadir.
...
-- variable ruzen42_github_io_libexedir.
...
-- using the environment variable ruzen42_github_io_sysconfdir.
...
libdir     = "/home/ruzen42/.cabal/lib/x86_64-linux-ghc-9.12.2-c687/ruzen42-github-io-0.1.0.0-inplace-site"
dynlibdir  = "/home/ruzen42/.cabal/lib/x86_64-linux-ghc-9.12.2-c687"
datadir    = "/home/ruzen42/.cabal/share/x86_64-linux-ghc-9.12.2-c687/ruzen42-github-io-0.1.0.0"
libexecdir = "/home/ruzen42/.cabal/libexec/x86_64-linux-ghc-9.12.2-c687/ruzen42-github-io-0.1.0.0"
sysconfdir = "/home/ruzen42/.cabal/etc"

getBinDir     = catchIO (getEnv "ruzen42_github_io_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "ruzen42_github_io_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "ruzen42_github_io_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "ruzen42_github_io_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "ruzen42_github_io_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "ruzen42_github_io_sysconfdir") (\_ -> return sysconfdir)
